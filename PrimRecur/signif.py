...
colH = {
	...
	'mutation': {'tbl':'mutation', 'locus':('concat(chrom,":",chrSta,"~",chrEnd,ref,">",alt)'), 'anchor':'concat(chrom,":",chrSta,"~",chrEnd,ref)', 'info':('ref','alt','strand','gene_symL','ch_dna','ch_aa','ch_type','cosmic','mutsig'), 'data':('nReads_alt','nReads_ref')}, \
	}
...
dTypeL = ['mutation']
#dTypeL = ['skip','fusion','eiJunc','mutation']
