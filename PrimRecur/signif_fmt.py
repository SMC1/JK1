...
for line in sys.stdin:
	...
	line = re.sub('S([0-9]{3}[^ABCS\-]*)', lambda mo: '%s' % mo.group(1), line)
	sys.stdout.write(re.sub('([0-9]{3}[^ABC\-\\t]*|S[0-9]{2})-([0-9]{3}[^ABC\-\\t]*|S[0-9]{2})',lambda mo: '%sP-%sR' % (mo.group(1),mo.group(2)),line))
