...
#main('/EQL1/NSL/RNASeq/NSL_GBM_RPKM_45_pathway_NTP.gct')
main('/EQL1/TCGA/GBM/RNASeq/TCGA_GBM_RPKM_pathway_NTP.gct')
#main('/EQL1/TCGA/GBM/array_gene/TCGA_GBM_BI_pathway_NTP.gct')
