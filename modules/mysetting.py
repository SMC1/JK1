...
SRC_HOME='/data1' + os.getenv('HOME') + '/JK1'

tcga_DB='/data1/Sequence/TCGA_MAFs/TCGA.merged.hg19.dat'
cosmic_DB='/data1/Sequence/cosmic/cosmic_confirmed.dat'
...
all_1kgH = {'smc1': {'hg19': '/data1/Sequence/ucsc_hg19/annot/ALL.wgs.phase1_release_v3.20101123.snps_indels_sv.sites.filtered_hg19.vcf'}, 'smc2': {'hg19': '/Z/Sequence/ucsc_hg19/annot/ALL.wgs.phase1_release_v3.20101123.snps_indels_sv.sites.filtered_hg19.vcf'}}
espH = {'smc1': {'hg19': '/data1/Sequence/ucsc_hg19/annot/ESP6500SI-V2-SSA137.updatedProteinHgvs.ALL.snps_indels.filtered_hg19.vcf'}, 'smc2': {'hg19': '/Z/Sequence/ucsc_hg19/annot/ESP6500SI-V2-SSA137.updatedProteinHgvs.ALL.snps_indels.filtered_hg19.vcf'}}
...
ctrMutectDir='/EQL3/pipeline/mutation_ctr'
...
poolB_CS_bam='/EQL1/NSL/WXS/results/CNA/CS_B_pool.recal.bam' ## for cancerscan (from 20 hapmap, downsampled & merged)
poolB_CS_rpkm='/EQL1/NSL/WXS/results/CNA/CS_B_pool.rpkm' ## for cancerscan (from 20 hapmap, from downsampled & merged bams)
poolB_CS_rpkm='/EQL1/NSL/WXS/results/CNA/CS_B_pool.v2.rpkm' ## for cancerscan (from 20 hapmap, averged from individual rpkm)
