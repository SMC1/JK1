...
)
{
  ...
  if (isPdf) pdf(sprintf('/data1/IRCR/JW/NRP/VEGF/%s_scatter1.pdf',dsetN))
  ...
  if (isPdf) pdf(sprintf('/data1/IRCR/JW/NRP/VEGF/%s_scatter2.pdf',dsetN))
  ...
  if (isPdf) pdf(sprintf('/data1/IRCR/JW/NRP/VEGF/%s_scatter3.pdf',dsetN))
...
pathGctPath = '/EQL1/TCGA/GBM/array_gene/TCGA_GBM_BI_pathway_TGFb.gct'
