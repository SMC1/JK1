...
if '--inSegFile' in optH:
	...
	inSegFileName = 'TCGA_GBM_CNA_SNP6.seg'

if '--inRefFlatFile' in optH:
	inRefFlatFileName = optH['--inRefFlatFile']
else:
	inRefFlatFileName = 'refFlat_hg18.txt'
...
for geneName in geneNameL:
	...
	trans = mygenome.transcript(geneName,inRefFlatFileName,assembly) # consider only the longest transcript per gene
