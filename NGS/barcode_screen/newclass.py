...
#for i in range(0,171,1):
#	tempdict={sequence2[i]:genename[i]}
#	gene2.update(tempdict)
...
#f1=open('464_827_Pool_1T_Barcode_1.fastq')
#f2=open('464_827_Pool_1T_Barcode_2.fastq')

f=os.popen('cat ./464_827_Pool_1T_Barcode_*.fastq','r')

pattern=re.compile('([ACTGN]{3})([ACTGN]{3})ACA[ATCGN]{11,13}CT[ATCGN]{2}([ATCGN]{8})[ATCGN]{3}([ATCGN]{8})[ATCGN]{56,58}')
#pattern2=re.compile('([ACTG]{6})ACATCTGTGGCTTCACT([ATCG]{11})([ATCG]{10})([ATCG]{57})')
count=0
iter=0
success=0
for line in f:
	...
	if count%4==2:
		...
		if match!=None and (sample.has_key(match.group(1)) or sample2.has_key(match.group(2))) and gene.has_key(match.group(3)):
		...
		#elif match==None and match2!=None:
		#	if sample.has_key(match2.group(1)) and gene2.has_key(match2.group(3)):
		#		success+=1
		#		verity+=1
		#		data[sample[match2.group(1)]][gene2[match2.group(3)]]+=1
	#if count>=1000000:
	#	break
f.close()
