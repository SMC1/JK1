...
sample={'CGTG':'464Ctrl','GCCT':'464_2','TGGT':'464_4','CACT':'827_4','ATTG':'464_6','GATC':'827_1','TCAA':'827Ctrl','CTGA':'827_2','AAGC':'827_3','GTAG':'827_6','TACA':'827_5'}
sample2={'TGAT':'464Ctrl','CTAA':'464_2','GTCA':'464_4','CTGT':'827_4','TGGC':'464_6','TCTG':'827_1','AAGT':'827Ctrl','GATC':'827_2','GCTA':'827_3','AGCC':'827_6','CAAG':'827_5'}
...
pattern2=re.compile('[ACTGN]{2}([ACTGN]{4})ACAT[ATCGN]{15}([ATCGN]{8})[ATCGN]{68}')
...
for line in f:
	...
	if count%4==2:
		...
		if match!=None and gene.has_key(match.group(2)):
			if sample.has_key(match.group(1)):
				success+=1
				data[sample[match.group(1)]][gene[match.group(2)]]+=1
			else:
				match2=re.match(pattern2,line)
				if sample2.has_key(match2.group(1)):
					success+=1
					data[sample2[match2.group(1)]][gene[match2.group(2)]]+=1
f.close()
