...
def main(inDirName,outDirName,pbs=False):
	...
	for sampN in sampNameL:
		...
		cmd = '%s/NGS/splice_gsnap/skipping/exonSkip_sort.py -i %s_splice_exonSkip_normal.gsnap.gz -r %s_splice_exonSkip_normal_report.txt -s %s' % (mysetting.SRC_HOME, iprefix, oprefix, sampN)
